...
nlp = spacy.load('en_core_web_sm')  # I have changed it from md to sm.
...
# Answer - Error W007 pops up. This is because SpaCy’s small model (en_core_web_sm) is not giving the best result
# for similarity methods because they don't ship with the word vectors tensors. So this may not give any useful
# similarity judgements. That's why we got the warning in the console. Using en_core_web_md instead of small models
# would be better as larger models are more accurate with their similarity judgements.
